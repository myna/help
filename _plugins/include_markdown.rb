...
eos
      ...
      def render(context)
        # parser = case Jekyll.configuration({})['markdown']
        #   when 'redcarpet'
        #     Jekyll.RedcarpetParser.new @config
        #   when 'kramdown'
        #     Jekyll.KramdownParser.new @config
        #   when 'rdiscount'
        #     Jekyll.RDiscountParser.new @config
        #   when 'maruku'
        #     Jekyll.MarukuParser.new @config
        #   else
...
Liquid::Template.register_tag('include_markdown', Jekyll::Tags::IncludeMarkdownTag)